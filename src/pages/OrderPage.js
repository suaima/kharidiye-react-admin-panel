...
// mock
import DATALIST from '../_mock/order';
...
const TABLE_HEAD = [
    ...
    { id: 'Paid', label: 'Verified', alignRight: false },
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                                        const { id, name, role, cDate, status, company, avatarUrl, isVerified } = row;
